...
HF_HUB_CACHE=/dev/shm python wan2p2_i2v_benchmark.py --size 720*1280 --batch_size 1 --dp 2 --bq 4864 --bkv 1024 --bkv_compute 1024 --bkv_compute_in 1024 --heads_per_tile 1 --frame_num 81
